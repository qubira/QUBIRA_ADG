...
function renderPage() {
  ...
  <div class="border-b border-gray-200 mb-5">
    <div class="flex gap-1 overflow-x-auto" id="tabs">
      ${['overview','github','scrum','requirements','contracts','documents','whatsapp','emails','activity'].map((t,i) => {
        const labels = ['Resumen','GitHub','Scrum',`Requisitos (${_requirements.length})`,`Contratos (${_contracts.length})`,`Documentos (${_documents.length})`,
