      ...
      <section class="qlogin-brand-side">
        <div>
          ...
          <div class="qlogin-hero">
            <div class="qlogin-eyebrow">Acceso de personal de ADG</div>
            <h1>Creación y aprobación de proyectos.</h1>
            <p>
              Inicia sesión con tu cuenta corporativa de Qubira para crear
              proyectos, cargar contratos y aprobar el cierre del trabajo de TI.
            </p>

            <div class="qlogin-hero-cards">
              <div class="qlogin-mini-card">
                <strong>Proyectos</strong>
                <span>Crea, aprueba y da seguimiento a cada proyecto de principio a fin.</span>
              </div>
              <div class="qlogin-mini-card">
